...
private:
	...
	GLuint compile_shader(GLenum shaderType, const char* fileName); //Metoda wczytuje i kompiluje shader, a następnie zwraca jego uchwyt
...
extern ShaderProgram* spLambertMultiTextured;
